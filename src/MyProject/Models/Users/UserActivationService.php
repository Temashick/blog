...
class UserActivationService
{
    ...
    public static function createActivationCode(User $user): string // создание активационного кода
    {
    ...
    public static function checkActivationCode(User $user, string $code):bool // активация регистрации проверкой активационного кода
    {
        $db = Db::getInstance();
        $result = $db->query(
    ...
    public static function deleteCode(int $userId): bool
    {
        $db = Db::getInstance();
        $result = $db->query(
